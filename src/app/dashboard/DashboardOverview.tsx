                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={idx} className="flex flex-col space-y-3">
                                <div
                                    className="aspect-[4/3] bg-gray-100 rounded-2xl relative overflow-hidden group-hover:brightness-95 transition-all bg-cover bg-center"
                                    style={{ backgroundColor: meal.data.imageColor || '#eee' }}
                                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={mIdx} className="flex flex-col space-y-3">
                                <div
                                    className="aspect-[4/3] bg-gray-100 rounded-2xl relative overflow-hidden bg-cover bg-center"
                                    style={{ backgroundColor: meal.data.imageColor || '#eee' }}
                                >
