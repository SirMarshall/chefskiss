                        ...
                        {isGenerating ? (
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center p-12 border-2 border-dashed border-gray-200 dark:border-gray-800 rounded-3xl bg-gray-50/50 dark:bg-zinc-800/30 text-center">
                                ...
                                <button
                                    ...
                                    disabled={isGenerating || isPlanLocked}
                                ...
                                <div className="p-8 md:p-12 space-y-10">
                                    ...
                                    <div className="pt-8 border-t border-gray-200 dark:border-gray-700">
                                        <button
                                            onClick={handleGeneratePlan}
                                            disabled={isGenerating || isPlanLocked}
                                            className={`w-full font-bold tracking-[0.2em] uppercase text-xs py-5 rounded-sm shadow-xl transition-all duration-300 transform flex items-center justify-center space-x-2 font-mono ${isGenerating || isPlanLocked
                                        ...
                                        >
                                            {isGenerating ? (
                                                ...
                                                <>
                                                    <span className="material-symbols-outlined">auto_awesome</span>
                                                    <span>{hasPlan ? "Regenerate Plan" : "Generate Plan"}</span>
                                                </>
                                            )}
                                        </button>
                                    </div>
