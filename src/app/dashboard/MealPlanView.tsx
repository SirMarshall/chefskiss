                ...
                {mealPlan.days.map((day: any, idx: number) => (
                    <div key={idx} className="space-y-6 pr-8 border-r border-gray-100 dark:border-gray-800 last:border-0 relative">
                        ...
                        {[
                            ...
                            <div key={mIdx} className="bg-white dark:bg-zinc-800 p-3 rounded-2xl shadow-[0_4px_12px_-2px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-gray-700 flex items-center gap-4 hover:shadow-md transition-all group cursor-pointer hover:border-primary/30">
                                <div className="w-[40%] flex-shrink-0">
                                    <div
                                        className="aspect-square rounded-lg bg-cover bg-center transition-colors"
                                        style={{
