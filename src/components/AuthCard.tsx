...
export default function AuthCard({ leftPanel, rightPanel }: AuthCardProps) {
    return (
        <div className="relative z-10 w-full md:w-[940px] max-w-[95vw] overflow-hidden flex flex-col md:flex-row rounded-3xl shadow-[0_35px_60px_-15px_rgba(0,0,0,0.6)] bg-white/90 backdrop-blur-3xl border border-[var(--card-border)] h-auto md:h-[780px] transition-none">
            {/* Left Panel */}
            <div className="w-full md:w-5/12 bg-gray-100/90 dark:bg-zinc-900/90 backdrop-blur-3xl p-10 flex flex-col justify-between relative border-r border-black/5 dark:border-white/5">
            ...
            {/* Right Panel */}
            <div className="w-full md:w-7/12 bg-white/90 dark:bg-black/80 backdrop-blur-3xl p-8 md:p-10 flex flex-col justify-center">
                {rightPanel}
            </div>
        </div>
    );
